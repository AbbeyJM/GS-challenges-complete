...
RSpec.describe 'integration' do
     ...
     describe "reading time behaviour" do
        ...
        it 'calculates reading time for all entries where it falls over a minutes' do
            diary = Diary.new
            diary_entry_1 = DiaryEntry.new('my title', 'my contents')
            diary_entry_2 = DiaryEntry.new('my title 2', 'my contents 2')
            diary.add(diary_entry_1)
     ...
     describe "best reading time entry behaviour" do
        context "we have just one entry and it's readable in the time" do
        ...
        context 'we have one entry and it is unreadable in that time' do
            diary = Diary.new
